...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    ...
    LCTL_T(KC_A),LSFT_T(KC_S),LALT_T(KC_D),LGUI_T(KC_F),KC_G     ,                            KC_H     , RGUI_T(KC_J),RALT_T(KC_K),RSFT_T(KC_L),RCTL_T(KC_MINS),
    KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     ,                            KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  ,
    KC_LCTL  ,LT(3,KC_SPC),KC_LALT  ,LSFT_T(KC_LNG2),LT(1,KC_LNG1),LGUI_T(KC_SPC),KC_BSPC,LT(2,KC_ENT),LSFT_T(KC_LNG2),KC_RALT,KC_RGUI, KC_RSFT
  ),
